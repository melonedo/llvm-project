...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.b(i32 %a, i32 %b, i8 0)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.b(i32 %a, i32 %b, i8 1)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.b(i32 undef, i32 %a, i8 0)
  %2 = call i32 @llvm.riscv.cv.insert.b(i32 %1, i32 %b, i8 1)
  %3 = call i32 @llvm.riscv.cv.insert.b(i32 %2, i32 %c, i8 2)
  %4 = call i32 @llvm.riscv.cv.insert.b(i32 %3, i32 %d, i8 3)
  ret i32 %4
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.h(i32 %a, i32 %b, i8 0)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.h(i32 %a, i32 %b, i8 1)
  ret i32 %1
}
...
; CHECK-NEXT:    cv.insert.h a0, a1, 1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.insert.h(i32 undef, i32 %a, i8 0)
  %2 = call i32 @llvm.riscv.cv.insert.h(i32 %1, i32 %b, i8 1)
  ret i32 %2
}
