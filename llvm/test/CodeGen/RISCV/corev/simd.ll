...
declare i32 @llvm.riscv.cv.simd.sdotup.h(i32, i32)

define i32 @test.cv.sdotup.h(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotup.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotup.h a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.h(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotup.b(i32, i32)

define i32 @test.cv.sdotup.b(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotup.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotup.b a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.b(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotup.sc.h(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.sc.h(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotup.sci.h(i32 %a) {
; CHECK-LABEL: test.cv.sdotup.sci.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotup.sci.h a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.sc.h(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotup.sc.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.sc.b(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotup.sci.b(i32 %a) {
; CHECK-LABEL: test.cv.sdotup.sci.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotup.sci.b a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotup.sc.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotusp.h(i32, i32)

define i32 @test.cv.sdotusp.h(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotusp.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotusp.h a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.h(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotusp.b(i32, i32)

define i32 @test.cv.sdotusp.b(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotusp.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotusp.b a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.b(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotusp.sc.h(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.sc.h(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotusp.sci.h(i32 %a) {
; CHECK-LABEL: test.cv.sdotusp.sci.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotusp.sci.h a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.sc.h(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotusp.sc.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.sc.b(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotusp.sci.b(i32 %a) {
; CHECK-LABEL: test.cv.sdotusp.sci.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotusp.sci.b a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotusp.sc.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotsp.h(i32, i32)

define i32 @test.cv.sdotsp.h(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotsp.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotsp.h a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.h(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotsp.b(i32, i32)

define i32 @test.cv.sdotsp.b(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.sdotsp.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotsp.b a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.b(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotsp.sc.h(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.sc.h(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotsp.sci.h(i32 %a) {
; CHECK-LABEL: test.cv.sdotsp.sci.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotsp.sci.h a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.sc.h(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.sdotsp.sc.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.sc.b(i32 %a, i32 %b)
  ret i32 %1
}

define i32 @test.cv.sdotsp.sci.b(i32 %a) {
; CHECK-LABEL: test.cv.sdotsp.sci.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.sdotsp.sci.b a0, a0, 5
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sdotsp.sc.b(i32 %a, i32 5)
  ret i32 %1
}
...
declare i32 @llvm.riscv.cv.simd.shuffleI0.sci.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffleI0.sci.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.shuffleI1.sci.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffleI1.sci.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.shuffleI2.sci.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffleI2.sci.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.shuffleI3.sci.b(i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffleI3.sci.b(i32 %a, i32 5)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.shuffle2.h(i32, i32)

define i32 @test.cv.shuffle2.h(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.shuffle2.h:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.shuffle2.h a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffle2.h(i32 %a, i32 %b)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.shuffle2.b(i32, i32)

define i32 @test.cv.shuffle2.b(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.shuffle2.b:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.shuffle2.b a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.shuffle2.b(i32 %a, i32 %b)
  ret i32 %1
}
...
declare i32 @llvm.riscv.cv.simd.cplxmul.r(i32, i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.r(i32 %a, i32 %b, i32 1)
  ret i32 %1
}

declare i32 @llvm.riscv.cv.simd.cplxmul.i(i32, i32, i32)
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.i(i32 %a, i32 %b, i32 1)
  ret i32 %1
}

define i32 @test.cv.cplxmul.r.div2(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.r.div2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.r.div2 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.r(i32 %a, i32 %b, i32 2)
  ret i32 %1
}

define i32 @test.cv.cplxmul.i.div2(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.i.div2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.i.div2 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.i(i32 %a, i32 %b, i32 2)
  ret i32 %1
}

define i32 @test.cv.cplxmul.r.div4(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.r.div4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.r.div4 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.r(i32 %a, i32 %b, i32 4)
  ret i32 %1
}

define i32 @test.cv.cplxmul.i.div4(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.i.div4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.i.div4 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.i(i32 %a, i32 %b, i32 4)
  ret i32 %1
}

define i32 @test.cv.cplxmul.r.div8(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.r.div8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.r.div8 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.r(i32 %a, i32 %b, i32 8)
  ret i32 %1
}

define i32 @test.cv.cplxmul.i.div8(i32 %a, i32 %b) {
; CHECK-LABEL: test.cv.cplxmul.i.div8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    cv.cplxmul.i.div8 a0, a0, a1
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.cplxmul.i(i32 %a, i32 %b, i32 8)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.subrotmj(i32 %a, i32 %b, i32 4)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.subrotmj(i32 %a, i32 %b, i32 8)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.add.h(i32 %a, i32 %b, i32 4)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.add.h(i32 %a, i32 %b, i32 8)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sub.h(i32 %a, i32 %b, i32 4)
  ret i32 %1
}
...
; CHECK-NEXT:    ret
  %1 = call i32 @llvm.riscv.cv.simd.sub.h(i32 %a, i32 %b, i32 8)
  ret i32 %1
}
